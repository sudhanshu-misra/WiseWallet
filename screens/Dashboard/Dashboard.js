...
import { View, ScrollView, Text, TouchableOpacity,StyleSheet, Dimensions  } from 'react-native'; // Make sure to import Text
...
<View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: 10, marginRight: 10 }}>
  <TouchableOpacity onPress={() => setSwitchGraph(false)} style={{ flexDirection: 'row', alignItems: 'center' }}>
    <View style={{ width: 10, height: 10, backgroundColor: 'lightgreen', marginRight: 5 }}></View>
    <Text style={{ color: 'lightgreen' }}>Income</Text>
  </TouchableOpacity>
  <TouchableOpacity onPress={() => setSwitchGraph(true)} style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 10 }}>
    <View style={{ width: 10, height: 10, backgroundColor: 'lightblue', marginRight: 5 }}></View>
    <Text style={{ color: 'lightblue' }}>Expense</Text>
          ...
          <LineChart
            ...
            spacing={9}
            thickness={3}
            startFillColor={switchGraph ? "rgba(183, 244, 216,1)" : "rgba(201, 242, 155,1)"}
            endFillColor={switchGraph ? "rgba(183, 244, 216,1)" : "rgba(201, 242, 155,1)"}
            startOpacity={1}
            endOpacity={0}
            initialSpacing={0}
            noOfSections={5}
  ...
  <TouchableOpacity onPress={() => navigation.navigate('IncomeHome')} style={{ backgroundColor: 'white', padding: 4, borderRadius: 5 }}>
            <Text style={{ color: 'blue', fontWeight: 'bold', textAlign: 'center'}}>View All</Text>
          </TouchableOpacity>

           <Text style={{ textAlign: 'center', fontSize: 20, marginTop: 5, marginBottom: 10 }}>EXPENSE</Text>
