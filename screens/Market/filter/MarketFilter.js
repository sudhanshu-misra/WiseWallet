...
import {productCategory,collegePrograms,doctoralPrograms,undergraduateCourses,postgraduateCourses,semester,postGrad_semester} from '../../../components/Form/Icon/IconData';
      ...
      <View className="flex flex-row w-full flex-[75%]">
        ...
        <ScrollView
            ...
            productCategory.map((product, index) => {
              return (
                <View key={index} className="flex-1 flex-row items-center ">
                  <RadioButton
                    value={product}
                    status={categoryName === product ? 'checked' : 'unchecked'}
          ...
          {selected === 'program' && !programName &&
            ...
            {/* courses */}
            {selected==='program' && programName==='UNDERGRADUATE PROGRAMS' && !courseName &&
            ...
            {selected==='program' && programName==='POSTGRADUATE PROGRAMS' && !courseName &&
            ...
            {selected==='program' && programName==='DOCTORAL PROGRAMS' && !courseName &&
            ...
            {/* semester */}
             ...
             {
                selected==='program' && (programName==='DOCTORAL PROGRAMS'|| programName==='UNDERGRADUATE PROGRAMS'  ) && courseName && 
        ...
        
             {
              ...
              return (<View key={index} className="flex-1 flex-row items-center ">
                  <RadioButton
                    value={sem}
                    status={semesterValue === sem ? 'checked' : 'unchecked'}
                    onPress={() => setSemesterValue(sem)}
