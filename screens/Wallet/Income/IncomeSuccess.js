  ...
  return (
    <View style={[styles.wallet, styles.fadeLayout]}>
      ...
      <View style={styles.menu}>
        <Pressable style={styles.iconLayout2} onPress={() => {}}>
          <Image
      ...
      <View style={[styles.container2, styles.containerPosition]}>
        <View style={styles.transactionCard}>
          <View
            style={[styles.transactionCard1, styles.transactionCardBorder1]}
          >
            <View
          ...
          <View style={styles.setUpBudgetCardseeMore}>
            <View style={[styles.checkBoxSingIn, styles.buttonSpaceBlock]}>
              <Image
                style={[styles.checkBoxIcon, styles.iconLayout2]}
                resizeMode="cover"
      ...
      <View style={[styles.fade, styles.containerPosition]}>
        <View style={styles.verticalContainer10}>
          ...
          <View style={[styles.verticalContainer11, styles.containerPosition]}>
            ...
            <Text
              style={[styles.yourIncomeHas, styles.successfulTypo]}
            >{`Your income has been successfully add to earnings `}</Text>
          </View>
          ...
          <View
            style={[styles.transactionCard10, styles.transactionCardBorder1]}
          >
            <View
              style={[styles.transactionCardInner, styles.frameChildFlexBox]}
            >
              <View style={styles.transactionParent}>
                <View style={styles.transaction}>
                  <Image
                    style={styles.transactionChild}
                    resizeMode="cover"
                    source={require("../assets/switch-container6.png")}
                  />
                  <Image
                    style={[styles.familyRestroomIcon, styles.iconPosition]}
                    resizeMode="cover"
                ...
                <View style={styles.frameParent}>
                  ...
                  >
                    ...
                    <Image
                      style={styles.editIconLayout}
                      resizeMode="cover"
                      source={require("../assets/edit12.png")}
                    />
                  </View>
                  <View style={[styles.nov08Parent, styles.frameChildFlexBox]}>
                    <Text
                      style={[styles.nov08, styles.nov08Clr]}
                    >{`Nov 18 `}</Text>
                    <Text style={[styles.text4, styles.amClr]}>$2000</Text>
                  </View>
                </View>
              </View>
            </View>
      ...
      <View style={[styles.footer, styles.footerFlexBox]}>
        ...
        <View style={[styles.goal, styles.goalLayout]}>
          <Image
            style={[styles.savingsIcon, styles.iconLayout2]}
            resizeMode="cover"
        ...
        <View style={[styles.goal, styles.goalLayout]}>
          <Image
            style={[styles.assessmentIcon, styles.iconLayout2]}
            resizeMode="cover"
