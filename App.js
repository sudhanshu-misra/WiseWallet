  ...
  if (isLoading) {
    ...
    return (
      <GlobalContextProvider
        value={{isMarket, setIsMarket, whislist, setwhislist, fetchorders, setfetchorders, isAuthenticated, setIsAuthenticated, profileData, setProfileData ,fetchproducts,setfetchproducts}}>
        <NavigationContainer>
          <SafeAreaProvider>
            <Stack.Navigator
              screenOptions={{
